...
export const NORMAL: CaseValues = {
  ...
  smoking_packyears: 0,
  breast_density: 2,
  family_history_breast: 0,
  prior_breast_biopsy: 0,
  age_at_first_birth: 0,
  last_mammogram_result: 0,
  surgical_menopause: 0,
  hormone_therapy: 0,
  cotinine: 0.05,
  crp: 1.2,
  prostate_volume: 28,
...
export const CASE_POOL: DemoCase[] = [
  ...
  },
  {
    ...
    expect: "No cancer detected",
    positive: false,
    source: "Breast Cancer Surveillance Consortium, screening mammograms, negative record",
    note: "42 year old woman after a screening mammogram reported as almost entirely fatty. No first-degree relatives with breast cancer, no previous biopsy.",
  ...
  },
  {
    ...
    positive: false,
    source: "Breast Cancer Surveillance Consortium, screening mammograms, negative record",
    note: "37 year old woman after a screening mammogram reported as scattered fibroglandular density. No first-degree relatives with breast cancer, no previous biopsy.",
  ...
  },
  {
    ...
    note: "52 year old woman with hepatitis C. AFP at 3.1 ng/mL.",
  ...
  },
  {
    ...
    positive: true,
    source: "NHANES 2005-2018, US adults, positive record",
    note: "54 year old man with hepatitis C, diabetes. AFP at 3.1 ng/mL.",
  ...
  },
  {
    ...
    positive: false,
    source: "NHANES 2005-2018, US adults, negative record",
    note: "20 year old woman with no viral hepatitis or cirrhosis on record. AFP at 3.1 ng/mL.",
  ...
  },
  {
    ...
    expect: "No cancer detected",
    positive: false,
    source: "NHANES 1999-2016, adults with tobacco exposure, negative record",
    note: "27 year old man, current smoker, 7.2 pack-years. Serum cotinine 13.2 ng/mL, CRP 1.2 mg/L, WBC 8, haemoglobin 15.8.",
  ...
  },
  {
    ...
    positive: false,
    source: "NHANES 1999-2016, adults with tobacco exposure, negative record",
    note: "46 year old man, current smoker, 7.2 pack-years. Serum cotinine 212.7 ng/mL, CRP 0.4 mg/L, WBC 7.7, haemoglobin 16.2.",
  ...
  },
  {
    ...
    positive: false,
    source: "NHANES 1999-2016, adults with tobacco exposure, negative record",
    note: "39 year old man, current smoker, 7.2 pack-years. Serum cotinine 63.44 ng/mL, CRP 0.4 mg/L, WBC 11.1, haemoglobin 16.1.",
