...
export const CASE_POOL: DemoCase[] = [
  ...
  },
  {
    ...
    expect: "No cancer detected",
    positive: false,
    source: "Caracas colposcopy referral cohort, negative record",
    note: "26 year old woman being assessed for colposcopy. 10 lifetime partners, first intercourse at 16, 1 pregnancies. smokes, 0.513202 pack-years, 0.5 years on hormonal contraceptives.",
    delta: { age: 26, sexual_partners: 10, first_intercourse_age: 16, smokes: 1, smoking_years: 9, smoking_packyears: 0.5132, hormonal_contraceptives: 1, hormonal_contraceptives_years: 0.5 },
  },
  {
    id: "cervical-neg-44",
    domain: "Cervical",
    ...
    positive: false,
    source: "Caracas colposcopy referral cohort, negative record",
    note: "44 year old woman being assessed for colposcopy. 3 lifetime partners, first intercourse at 26, 4 pregnancies. 2 years on hormonal contraceptives.",
    delta: { age: 44, sexual_partners: 3, first_intercourse_age: 26, pregnancies: 4, hormonal_contraceptives: 1, hormonal_contraceptives_years: 2 },
  },
  {
    id: "cervical-neg-45",
    domain: "Cervical",
    ...
    positive: false,
    source: "Caracas colposcopy referral cohort, negative record",
    note: "31 year old woman being assessed for colposcopy. 3 lifetime partners, first intercourse at 15, 5 pregnancies. 0.5 years on hormonal contraceptives.",
    delta: { age: 31, sexual_partners: 3, first_intercourse_age: 15, pregnancies: 5, hormonal_contraceptives: 1, hormonal_contraceptives_years: 0.5 },
  },
];
