...
export const LAB_GROUPS: LabGroup[] = [
  ...
  },
  {
    ...
    blurb: "All thirty measurements from a digitised breast biopsy. You will only have these if a lump has been sampled and imaged, and they come straight off that report. Using four of them instead of thirty scored 0.680 on small lesions against 0.952 for the full set, so the extra typing buys real accuracy exactly where it matters.",
    items: [
      ...
      { key: "smoothness_mean", label: "Smoothness (mean)", unit: "", normal: "see report", meaning: "Local variation in the radius. Irregular edges suggest malignancy. This is average across the nuclei." },
      { key: "compactness_mean", label: "Compactness (mean)", unit: "", normal: "see report", meaning: "Perimeter squared over area. Rises as the shape gets less circular. This is average across the nuclei." },
      { key: "concavity_mean", label: "Concavity (mean)", unit: "", normal: "see report", meaning: "How severe the indentations in the outline are. This is average across the nuclei." },
      { key: "concave_points_mean", label: "Concave points (mean)", unit: "", normal: "see report", meaning: "How many indentations the outline has. This is average across the nuclei." },
      { key: "symmetry_mean", label: "Symmetry (mean)", unit: "", normal: "see report", meaning: "How symmetric the nucleus is about its axis. This is average across the nuclei." },
      { key: "fractal_dimension_mean", label: "Fractal dimension (mean)", unit: "", normal: "see report", meaning: "How irregular the boundary is at fine scale. This is average across the nuclei." },
      { key: "radius_se", label: "Radius (se)", unit: "", normal: "see report", meaning: "Distance from the centre of a nucleus to its edge. Malignant nuclei run larger. This is standard error across the nuclei." },
      { key: "texture_se", label: "Texture (se)", unit: "", normal: "see report", meaning: "How much the grey scale varies across the nucleus. Malignant nuclei look more mottled. This is standard error across the nuclei." },
      { key: "perimeter_se", label: "Perimeter (se)", unit: "", normal: "see report", meaning: "Length around the edge of the nucleus. This is standard error across the nuclei." },
      { key: "area_se", label: "Area (se)", unit: "", normal: "see report", meaning: "Cross sectional area of the nucleus. This is standard error across the nuclei." },
      { key: "smoothness_se", label: "Smoothness (se)", unit: "", normal: "see report", meaning: "Local variation in the radius. Irregular edges suggest malignancy. This is standard error across the nuclei." },
      { key: "compactness_se", label: "Compactness (se)", unit: "", normal: "see report", meaning: "Perimeter squared over area. Rises as the shape gets less circular. This is standard error across the nuclei." },
      { key: "concavity_se", label: "Concavity (se)", unit: "", normal: "see report", meaning: "How severe the indentations in the outline are. This is standard error across the nuclei." },
      { key: "concave_points_se", label: "Concave points (se)", unit: "", normal: "see report", meaning: "How many indentations the outline has. This is standard error across the nuclei." },
      { key: "symmetry_se", label: "Symmetry (se)", unit: "", normal: "see report", meaning: "How symmetric the nucleus is about its axis. This is standard error across the nuclei." },
      { key: "fractal_dimension_se", label: "Fractal dimension (se)", unit: "", normal: "see report", meaning: "How irregular the boundary is at fine scale. This is standard error across the nuclei." },
      { key: "radius_worst", label: "Radius (worst)", unit: "", normal: "see report", meaning: "Distance from the centre of a nucleus to its edge. Malignant nuclei run larger. This is the most extreme nucleus in the sample." },
      { key: "texture_worst", label: "Texture (worst)", unit: "", normal: "see report", meaning: "How much the grey scale varies across the nucleus. Malignant nuclei look more mottled. This is the most extreme nucleus in the sample." },
      { key: "perimeter_worst", label: "Perimeter (worst)", unit: "", normal: "see report", meaning: "Length around the edge of the nucleus. This is the most extreme nucleus in the sample." },
      { key: "area_worst", label: "Area (worst)", unit: "", normal: "see report", meaning: "Cross sectional area of the nucleus. This is the most extreme nucleus in the sample." },
      { key: "smoothness_worst", label: "Smoothness (worst)", unit: "", normal: "see report", meaning: "Local variation in the radius. Irregular edges suggest malignancy. This is the most extreme nucleus in the sample." },
      { key: "compactness_worst", label: "Compactness (worst)", unit: "", normal: "see report", meaning: "Perimeter squared over area. Rises as the shape gets less circular. This is the most extreme nucleus in the sample." },
      { key: "concavity_worst", label: "Concavity (worst)", unit: "", normal: "see report", meaning: "How severe the indentations in the outline are. This is the most extreme nucleus in the sample." },
      { key: "concave_points_worst", label: "Concave points (worst)", unit: "", normal: "see report", meaning: "How many indentations the outline has. This is the most extreme nucleus in the sample." },
      { key: "symmetry_worst", label: "Symmetry (worst)", unit: "", normal: "see report", meaning: "How symmetric the nucleus is about its axis. This is the most extreme nucleus in the sample." },
      { key: "fractal_dimension_worst", label: "Fractal dimension (worst)", unit: "", normal: "see report", meaning: "How irregular the boundary is at fine scale. This is the most extreme nucleus in the sample." },
    ],
  },
];
