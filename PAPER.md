...
#### The rest of the checkup, and a third reversal

<!-- AUTOGEN:checkup -->
Every panel here reads two tests, a blood count and a metabolic panel, and two panels were withdrawn because those added nothing to age and sex. A routine checkup produces more paper than that: an HbA1c, a lipid panel, a urine albumin, a blood pressure, a waist measurement. None of it had been pulled. Adding all of it, on the same rows and the same targets, changes the bowel panel by -0.0314 against age and sex (-0.0369 to -0.0254) on 113 cancers, and the general panel by +0.0155 (+0.0126 to +0.0174) on 920. On the second panel that clears both internal bars: its rule-out cut also excludes +4.9% more adults than a cut on age and sex at the same share of cancers caught (+0.1% to +9.4%). **Then it was tested on NHANES III**, 1988-1994, 13,810 adults and 217 cancers, a cohort sharing no protocol, laboratory contract or pipeline with the training survey. The internal gain reverses: -0.0262 against age and sex (-0.0543 to +0.0008), with the rule-out excluding -5.7% more adults rather than fewer. **Both panels stay withdrawn.** This is the third time in this project that a gain measured inside one survey has failed to survive a change of decade, and the first where the extra information was not a cleverer model but more of the patient's own report. Routine checkup values beyond the blood count carry nothing about these cancers that the patient's age does not already carry.
<!-- /AUTOGEN:checkup -->
